...
used in the paper/report. The checked-in output directory is:
...
The defaults are the paper settings:
...
For a quick end-to-end check without regenerating paper outputs:
...
Smoke-run results are not comparable to the paper figures.
