...
```bash
uv run python -m experiments.ib_architecture.validate_classical
```

This regenerates:

```text
experiments/ib_architecture/validate_classical.png
```
...
```bash
uv run python -m experiments.ib_architecture.ku_demo
```

This writes:

```text
experiments/ib_architecture/ku_demo_outputs/ku_regret_data.tex
experiments/ib_architecture/ku_demo_outputs/ku_regret_preview.png
```
...
```bash
uv run python -m experiments.ib_architecture.newcomb_accuracy
```

This writes:

```text
experiments/ib_architecture/newcomb_accuracy_outputs/newcomb_accuracy_data.tex
experiments/ib_architecture/newcomb_accuracy_outputs/newcomb_accuracy_preview.png
```
