...
| Trap-bandit robustness figures and summary table | `experiments/trap_bandit` | `uv run python -m experiments.trap_bandit.run` | `experiments/trap_bandit/results_report_200_pcat001/` |
